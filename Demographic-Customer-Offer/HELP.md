...
* The original package name 'Customer.Demographic-Customer-Offer' is invalid and this project uses 'Customer.DemographicCustomerOffer' instead.
...
* [Spring HATEOAS](https://docs.spring.io/spring-boot/docs/2.7.14/reference/htmlsinge/index.html#web.spring-hateoas)
